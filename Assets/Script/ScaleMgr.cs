...
public class ScaleMgr : MonoBehaviour {
	...
	public void ScaleXObjectRight()
	{
		...
		ObjekHouse.transform.localScale = new Vector3(ObjekHouse.transform.localScale.x, ObjekHouse.transform.localScale.y, ObjekHouse.transform.localScale.z + 0.13f);
	...
	public void ScaleYObjectUp()
	{
		...
		ObjekHouse.transform.localScale = new Vector3(ObjekHouse.transform.localScale.x + 0.07f, ObjekHouse.transform.localScale.y, ObjekHouse.transform.localScale.z);
